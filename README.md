...
🔭 I'm currently exploring fun projects with the Apple GPU, like [bringing Nanite from Unreal Engine 5 to macOS](https://github.com/philipturner/ue5-nanite-macos) and [making a Metal backend for hipSYCL](https://github.com/illuhad/hipSYCL/issues/460).

⚡ I brought back [Swift for TensorFlow](https://github.com/tensorflow/swift) and the [Swift Jupyter kernel](https://github.com/google/swift-jupyter), then worked on transforming S4TF into a universal platform for GPU-accelerated machine learning. [s4tf-subprojects](https://github.com/philipturner/s4tf-subprojects) for an overview of this effort.
